...
public class signin extends JFrame {
	...
	public signin() {
		...
		lblEnterYourName.setFont(new Font("Segoe Print", Font.BOLD | Font.ITALIC, 18));
		lblEnterYourName.setBounds(86, 108, 238, 43);
		contentPane.add(lblEnterYourName);
		
		JLabel lblEnterYourSurname = new JLabel("Enter Your Surname  :");
		lblEnterYourSurname.setFont(new Font("Segoe Print", Font.BOLD | Font.ITALIC, 18));
		lblEnterYourSurname.setBounds(86, 189, 208, 29);
		contentPane.add(lblEnterYourSurname);
		
		JLabel lblEnterUsername = new JLabel("Enter Username       :");
		lblEnterUsername.setFont(new Font("Segoe Print", Font.BOLD | Font.ITALIC, 18));
		lblEnterUsername.setBounds(86, 257, 222, 29);
		contentPane.add(lblEnterUsername);
		
		JLabel lblEnterPassword = new JLabel("Enter Password       :");
		lblEnterPassword.setFont(new Font("Segoe Print", Font.BOLD | Font.ITALIC, 18));
		lblEnterPassword.setBounds(87, 326, 221, 29);
		...
		rdbtnFemale.setBounds(461, 410, 87, 43);
		contentPane.add(rdbtnFemale);
		
		JLabel lblGender = new JLabel("GENDER :");
		lblGender.setFont(new Font("Segoe Print", Font.BOLD | Font.ITALIC, 18));
		...
		btnSubmit.setFont(new Font("Magneto", Font.BOLD, 18));
		...
		lblNewLabel.setIcon(new ImageIcon("F:\\SignalTA.jpg"));
